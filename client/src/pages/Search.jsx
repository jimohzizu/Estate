...
const Search = () => {
  ...
  useEffect(() => {
    ...
    const parkingFromUrl = urlParams.get("parking", sidebardata.parking);
    const furnishedFromUrl = urlParams.get("furnished", sidebardata.furnished);
    const offerFromUrl = urlParams.get("offer", sidebardata.offer);
